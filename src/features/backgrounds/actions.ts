...
const backgroundUpdate = z.object({
  ...
  title: z.string().nonempty("Role must contain at least 1 character(s)").optional(),
  ...
  export async function updateBackgroundAction(_: PreviousState, formData: FormData) {
